        ...
        <tbody>
          <tr v-for="article in articles" :key="article.id">
            ...
            <td v-if="article.is_draft">
              <div class="buttons">
                <b-button tag="nuxt-link" :to="'/admin/draft/' + article.id">Edit</b-button>
                <PublishButton :id="article.id.toString()" :title="article.title" />
              </div>
            </td>
            <td v-else>
              <b-button tag="nuxt-link" :to="'/admin/article/' + article.id">Edit as draft</b-button>
            </td>
          </tr>
        </tbody>
      </table>
