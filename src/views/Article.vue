  ...
  <div class="article">
    <section class="section">
      <div class="container">
        ...
        <div class="columns">
          <div class="column has-text-left" id="contents">
            <strong>Contents:</strong>
            <ol>
              <li><a>Sonata vs. sonata form</a></li>
              <li><a>History of the sonata</a></li>
